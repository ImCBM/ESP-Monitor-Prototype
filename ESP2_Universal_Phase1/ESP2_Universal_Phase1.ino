...
//                        (Phase 4 Features)
// ============================================================================
// Positioning and distance calculation parameters
const unsigned long TRIANGULATION_INTERVAL = 30000;  // Update positions every 30 seconds
const int MIN_PEERS_FOR_TRIANGULATION = 2;           // Minimum peers needed for positioning
...
// Phase 4: Triangulation and Positioning
unsigned long lastTriangulation = 0;
...
bool hasEnoughPeersForTriangulation() {
  // Check if sufficient validated peers are available for triangulation
  int validPeers = 0;
  for (int i = 0; i < peerCount; i++) {
    if (knownPeers[i].handshakeComplete && knownPeers[i].validated) {
      validPeers++;
